...
import { manifest } from './manifest_CPlYeNmQ.mjs';
...
const _page5 = () => import('./pages/api/auth/forgot-password.astro.mjs');
const _page6 = () => import('./pages/api/auth/login.astro.mjs');
const _page7 = () => import('./pages/api/auth/logout.astro.mjs');
const _page8 = () => import('./pages/api/auth/refresh.astro.mjs');
const _page9 = () => import('./pages/api/auth/register.astro.mjs');
const _page10 = () => import('./pages/api/auth/reset-password.astro.mjs');
const _page11 = () => import('./pages/api/auth/verify-email.astro.mjs');
const _page12 = () => import('./pages/api/blog/articles.astro.mjs');
const _page13 = () => import('./pages/api/blog/_slug_.astro.mjs');
const _page14 = () => import('./pages/api/cities/european.astro.mjs');
const _page15 = () => import('./pages/blog/_slug_.astro.mjs');
const _page16 = () => import('./pages/blog.astro.mjs');
const _page17 = () => import('./pages/confirm-email.astro.mjs');
...
const pageMap = new Map([
    ...
    ["src/pages/api/auth/forgot-password.ts", _page5],
    ["src/pages/api/auth/login.ts", _page6],
    ["src/pages/api/auth/logout.ts", _page7],
    ["src/pages/api/auth/refresh.ts", _page8],
    ["src/pages/api/auth/register.ts", _page9],
    ["src/pages/api/auth/reset-password.ts", _page10],
    ["src/pages/api/auth/verify-email.ts", _page11],
    ["src/pages/api/blog/articles.ts", _page12],
    ["src/pages/api/blog/[slug].ts", _page13],
    ["src/pages/api/cities/european.ts", _page14],
    ["src/pages/blog/[slug].astro", _page15],
    ["src/pages/blog.astro", _page16],
    ["src/pages/confirm-email.astro", _page17],

...
/** @type {(inputs: {}) => string} */
const forgot_password$3 = () => `Forgot Password`;

// eslint-disable

/** @type {(inputs: {}) => string} */
const forgot_password$2 = () => `Mot de passe oublié`;

// eslint-disable

/** @type {(inputs: {}) => string} */
const forgot_password$1 = () => `Olvidé mi contraseña`;
...
*/
/* @__NO_SIDE_EFFECTS__ */
const forgot_password = (inputs= {}, options = {}) => {
	const locale = options.locale ?? getLocale();
	if (locale === "en") return forgot_password$3()
	if (locale === "fr") return forgot_password$2()
	if (locale === "es") return forgot_password$1()
...
const $$Navbar = createComponent(($$result, $$props, $$slots) => {
  ...
  function initCommunityDropdown() {
    ...
    console.log('\u{1F504} Initializing community dropdown...');
